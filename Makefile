LANGUAGE_NAME := tree-sitter-gero-lang
HOMEPAGE_URL := https://github.com/salty-max/tree-sitter-gero-lang
VERSION := 0.1.0
DESCRIPTION := Parser for gero-lang
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/gero-lang '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/gero-lang
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/gero-lang
